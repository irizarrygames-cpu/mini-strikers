...
function createSim() {
  ...
  const api = vm.runInContext(`({ Match, CLUBS, countryFor, CHARACTERS, pickBotCharacter, TRAILS, CELEBRATIONS, ACCESSORIES, DIFFICULTY, CFG, FORMATS, SIDES, Clubs, TEAMS })`, sandbox);
