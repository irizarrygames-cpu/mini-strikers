...
function createSim() {
  ...
  const api = vm.runInContext(`({ Match, CLUBS, countryFor, CHARACTERS, pickBotCharacter, TRAILS, CELEBRATIONS, ACCESSORIES, ULT_KINDS, DIFFICULTY, playerRamp, Levels, CFG, FORMATS, SIDES, Clubs, TEAMS })`, sandbox);
